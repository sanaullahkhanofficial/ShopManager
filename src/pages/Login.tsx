    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-brand-navy-900 via-brand-green-800 to-brand-green-600 p-4">
      <div className="w-full max-w-sm rounded-card bg-white p-8 shadow-2xl">
        <div className="mb-6 flex flex-col items-center text-center">
          <div className="mb-3"><Logo size={64} /></div>
          <h1 className="font-display text-xl font-bold leading-tight text-brand-navy-900">Haji Abdul Manan &amp; Abdul Hanan</h1>
          <p className="font-display text-sm font-semibold text-brand-green-700">Atta Dealer Pishin</p>
